...
<div class="contenedor-usuario">
    ...
    <form method="POST" class="fila">
        ...
        <button type="button" class="editar-btn" onclick="editarCampo('nombre_completo')">
            Editar
        </button>
    ...
    <form method="POST" class="fila">
        ...
        <button type="button" class="editar-btn" onclick="editarCampo('numero_documento')">
            Editar
        </button>
    ...
    <form method="POST" class="fila">
        ...
        <button type="button" class="editar-btn" onclick="editarCampo('email')">
            Editar
        </button>
    ...
    <form method="POST" class="fila">
        ...
        <button type="button" class="editar-btn" onclick="editarCampo('contrasena')">
            Editar
        </button>
    ...
    <form method="POST" class="fila">
        <div class="informacion">
            <h3>Carrera</h3>
            <p id="ver_id_carrera">
                <?= htmlspecialchars($usuario['nombre_carrera'] ?? 'Sin carrera') ?>
            </p>
            ...
            <select class="campo-edicion" id="editar_id_carrera" name="valor">
                <?php foreach ($carreras as $carrera): ?>
                    <option
                        value="<?= $carrera['id'] ?>"
                        <?= $carrera['id'] == $usuario['id_carrera'] ? 'selected' : '' ?>
                    >
        ...
        <button type="button" class="editar-btn" onclick="editarCampo('id_carrera')">
            Editar
        </button>
    ...
    <form method="POST" class="fila">
        ...
        <button type="button" class="editar-btn" onclick="editarCampo('telefono')">
            Editar
        </button>
